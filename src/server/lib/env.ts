...
export interface EnvSettings {
  ...
  SRTL_MAX_RUNNING_JOBS?: string;
  SRTL_MAX_RUNNING_SCANS?: string;
  SRTL_MAX_RUNNING_AUDITS?: string;
  SRTL_MAX_RUNNING_COPIES?: string;
  SRTL_COPY_FILE_CONCURRENCY?: string;
  SRTL_MAX_ACTIVE_COPY_FILES?: string;
  SRTL_JOB_HISTORY_RETENTION_DAYS?: string;
